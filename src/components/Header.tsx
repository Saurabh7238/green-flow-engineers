        ...
        <div className="border-t border-slate-100 bg-white px-4 py-4 md:hidden">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 border-t border-slate-200 pt-4">
            <a
              ...
              className="flex flex-col items-center gap-1 rounded-xl border border-slate-200 bg-white px-2 py-3 text-xs font-semibold text-slate-700 transition hover:border-brand-green hover:text-brand-green"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex flex-col items-center gap-1 rounded-xl bg-brand-green px-2 py-3 text-xs font-semibold text-white transition hover:bg-brand-green-dark"
            >
              <svg aria-hidden="true" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
