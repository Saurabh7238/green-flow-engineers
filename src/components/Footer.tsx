...
export async function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-slate-200 bg-slate-900 text-slate-300">
      ...
      <div className="mx-auto flex max-w-6xl justify-center gap-2 border-t border-slate-800 px-4 py-5 sm:gap-3 sm:px-6">
        <a
          href={siteConfig.phoneHref}
          className="inline-flex flex-1 items-center justify-center gap-1 rounded-lg border border-slate-600 px-2 py-2.5 text-xs font-semibold text-white transition hover:border-emerald-400 hover:text-emerald-400 sm:flex-none sm:gap-2 sm:px-4 sm:text-sm"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex flex-1 items-center justify-center gap-1 rounded-lg bg-brand-green px-2 py-2.5 text-xs font-semibold text-white transition hover:bg-brand-green-dark sm:flex-none sm:gap-2 sm:px-4 sm:text-sm"
        >
          <svg aria-hidden="true" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
